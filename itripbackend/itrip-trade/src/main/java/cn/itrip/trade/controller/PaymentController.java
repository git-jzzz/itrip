...
public String prePay(@PathVariable String orderNo, ModelMap model){
    ...
    public void pay(@RequestParam String WIDout_trade_no, @RequestParam String WIDsubject , @RequestParam String WIDtotal_amount, HttpServletResponse response){
        ...
        //调用RSA签名方式
        AlipayClient client = new DefaultAlipayClient(alipayConfig.getUrl(), alipayConfig.getAppid(), alipayConfig.getRsaPrivateKey(), alipayConfig.getFormat(), alipayConfig.getCharset(), alipayConfig.getAlipayprivateKey(),alipayConfig.getSignType());
    ...
    public void   notify(HttpServletRequest request,HttpServletResponse response){
       try {
           ...
           boolean verify_result = AlipaySignature.rsaCheckV1(params, alipayConfig.getAlipayprivateKey(), alipayConfig.getCharset(), "RSA2");
